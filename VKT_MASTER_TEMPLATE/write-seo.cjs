...
import { SEO_CHECKLIST_DATA } from '../data/constants';
import { showToast } from '../components/Toast';

interface Props { market?: string; initialTopic?: string; scriptSegments?: any[]; }

const SeoModule: React.FC<Props> = ({ market = Object.keys(CURRENT_NICHE.targetMarkets)[0], initialTopic = '', scriptSegments = [] }) => {
