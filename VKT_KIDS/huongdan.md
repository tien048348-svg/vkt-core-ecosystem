...
## 🚀 CHANGELOG: V16.5.7 (Kids - 2026-05-21)
...
- **Production Live Deploy Sync:** Deploy bản nâng cấp hoàn hảo lên máy chủ Vercel chính thức của Kids `kids.kiemtienvu.com`.
## 🚀 CHANGELOG: V16.5.6 (Kids - 2026-05-20)

- **English Duo Realistic Props Lock:** Bổ sung cơ chế khóa cứng đạo cụ học tập chân thực cho phong cách "Học Tiếng Anh (Mẹ & Bé)". Ép AI chỉ miêu tả các vật dụng thật ngoài đời (thẻ flashcard in sắc nét, trái cây tươi, đồ chơi nhựa, vở viết thật) và tuyệt đối cấm miêu tả đạo cụ dạng đất sét (clay), vải nỉ (felt) hay bìa giấy để đảm bảo giao diện học tập sạch sẽ, chuyên nghiệp chuẩn Pixar 3D đúng theo video mẫu học tiếng Anh.
- **Production Live Deploy Sync:** Deploy bản nâng cấp hoàn hảo lên máy chủ Vercel chính thức của Kids `kids.kiemtienvu.com`.

## 🚀 CHANGELOG: V16.5.5 (Kids - 2026-05-20)

- **English Duo Character Lock (Human Consistency):** Thiết lập cơ chế khóa cứng nhân vật nghiêm ngặt cho phong cách "Học Tiếng Anh (Mẹ & Bé)". Ép AI chỉ sinh hai nhân vật chính là NGƯỜI (Mẹ là "Mẹ" - loving human mother và Bé là "Bé" - cute human child), tuyệt đối cấm sử dụng các nhân vật động vật (gấu, thỏ, chó, mèo...) giúp đồng nhất hình ảnh nhân vật theo mẫu video học tiếng Anh trẻ em.
- **Production Live Deploy Sync:** Deploy bản nâng cấp hoàn hảo lên máy chủ Vercel chính thức của Kids `kids.kiemtienvu.com`.

## 🚀 CHANGELOG: V16.5.4 (Kids - 2026-05-19)
...
- **Production Live Deploy Sync:** Deploy bản dựng hoàn chỉnh lên Vercel chính thức của Kids `kids.kiemtienvu.com`.

## 🚀 CHANGELOG: V16.5.3 (Kids - 2026-05-19)

- **CSV Export Blank Row Separation:** Nâng cấp tính năng xuất Excel CSV kịch bản, tự động chèn thêm một hàng trống giữa các cảnh để định dạng tệp tải xuống được phân tách rõ ràng và khoa học.
- **Production Live Deploy Sync:** Deploy bản dựng hoàn chỉnh lên Vercel chính thức của Kids `kids.kiemtienvu.com`.

## 🚀 CHANGELOG: V16.5.2 (Kids - 2026-05-19)

- **Voice Profile UI Optimization (5-Column Grid):** Đồng bộ thiết kế dải thông số Voice Profile thành 5 cột (`AGE & DETAILS`, `ACCENT`, `TIMBRE`, `TONE`, `SPEED`) trên giao diện kịch bản và Studio để tối ưu hóa sự trực quan cho người dùng.
- **Production Live Deploy Sync:** Deploy bản dựng hoàn chỉnh lên Vercel chính thức của Kids `kids.kiemtienvu.com`.

## 🚀 CHANGELOG: V16.5.1 (Kids - 2026-05-19)

- **Duration Input Live Clamp:** Tích hợp bộ gạt tự động thời lượng tối đa về 10 phút ngay trong lúc gõ hoặc bấm thay đổi giá trị nhập liệu trên dự án VKT Kids, tự động hiển thị Toast cảnh báo chi tiết, giải quyết dứt điểm vấn đề hiển thị vượt quá 10 phút trên giao diện.
- **Production Live Deploy Sync:** Deploy bản dựng hoàn hảo, tối ưu hóa tuyệt đối lên máy chủ Vercel chính thức của Kids.
