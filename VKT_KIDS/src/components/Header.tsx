    ...
    <header className="bg-[#0a0e14]/95 backdrop-blur-md border-b border-amber-900/30 sticky top-0 z-50 shadow-[0_1px_3px_rgba(0,0,0,0.5)]">
      <div className="max-w-[1800px] mx-auto px-4 md:px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <div className="relative shrink-0 w-10 h-10 md:w-11 md:h-11 rounded-full p-[2px] bg-gradient-to-tr from-amber-500 via-yellow-200 to-amber-700 shadow-[0_0_15px_rgba(245,158,11,0.4)]">
          ...
          <div>
            <h1 className="text-lg md:text-xl font-black tracking-tighter text-slate-100">
              VKT <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-300">KIDS CARTOON STUDIO</span>
            </h1>
            <p className="text-[9px] text-amber-600/80 tracking-widest font-mono font-bold">AI ANIMATED STORIES FOR CHILDREN 🌟</p>
          </div>
        </div>
