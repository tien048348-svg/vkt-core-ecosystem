    ...
    <div className="fixed inset-0 bg-black/90 z-[100] flex items-center justify-center p-4 backdrop-blur-sm"
      ...
      <div className="bg-[#12161e] border border-amber-900/30 w-full max-w-md rounded-2xl p-6 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
        ...
        <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer"
          className="block mb-4 text-center py-2 px-4 bg-amber-900/10 border border-amber-500/20 rounded-lg text-xs text-amber-400 font-bold hover:bg-amber-900/20 transition-all">
          🔑 Lấy API tại đây
        </a>
