...
const ToastContainer: React.FC = () => {
  ...
  return (
    <div className="fixed top-20 right-6 z-[60] space-y-2 max-w-sm">
      {toasts.map(toast => {
        const colorMap = {
          error: 'bg-[#1C1315]/95 border-red-500/40 text-red-200',
          success: 'bg-[#1C1A13]/95 border-amber-500/40 text-amber-200',
          info: 'bg-[#13151C]/95 border-blue-500/40 text-blue-200',
        };
        const iconMap = {
