...
interface Props { market?: string; initialTopic?: string; uiLang: 'vi' | 'en'; }

const SeoModule: React.FC<Props> = ({ market = 'vn_dharma', initialTopic = '', uiLang }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-[slideIn_0.4s_ease-out]">
      <div className="bg-[#12161e] border border-slate-700/30 p-6 rounded-2xl shadow-lg">
        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2"><i className="fa-solid fa-leaf text-amber-500" /> {t.seo.title}</h2>
