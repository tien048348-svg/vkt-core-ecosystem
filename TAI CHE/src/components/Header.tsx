      ...
      <div className="max-w-[1800px] mx-auto px-4 md:px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[9px] text-amber-600/80 tracking-widest font-mono font-bold">RECYCLED FOLKLORE & ECO-ART STUDIO</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <button onClick={onOpenConfig}
            className="flex items-center gap-2 px-3 md:px-4 py-2 rounded-full text-xs font-bold bg-[#161a22] text-slate-400 border border-slate-700/50 hover:bg-[#1e2230] transition-all hover:text-slate-200">
            <i className="fa-solid fa-key"></i>
            <span className="hidden md:inline">Config</span>
            <span className={`ml-1 px-1.5 py-0.5 rounded-full text-[9px] font-bold ${keyCount > 0 ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 'bg-slate-800 text-slate-400'}`}>
              {keyCount}
            </span>
          </button>
        </div>
