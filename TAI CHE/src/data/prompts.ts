...
# CAC PHONG CACH NGHE THUAT CHINH:
1. Stop-Motion Papercraft: Bia carton, giay thu cong, ky thuat pop-up, mo hinh thu nho
2. Dong Ho Folk Art: Tranh dan gian, giay do, bot diep, moc ban truyen thong
3. Mua Roi Nuoc: Roi nuoc son mai, san khau noi, le hoi truyen thong
4. Plastic Mosaic: Nap chai, manh nhua tai che tao linh vat than thoai (Rong, Phuong)
5. Fabric Collage: Vai vun, quan ao cu, theu tay tao nhan vat dan gian
6. Pop-up Cardboard: Bia carton + ky thuat sach noi tao chieu sau khong gian
7. Natures Debris: La kho, vo hat, hat dau tao boi canh rung nui
...
- [NGÁCH MÃI XANH - EVERGREEN LESSON]: Ở phân cảnh cuối cùng (OUTRO), BẮT BUỘC phải truyền tải thông điệp cốt lõi: "Những thứ rác thải tưởng chừng đồ bỏ đi, nay đã hóa thành một câu chuyện cổ tích tuyệt đẹp". Từ đó đúc kết bài học môi trường và BẮT BUỘC lồng ghép tên kênh "Góc nhỏ cổ tích" thật tự nhiên vào câu hỏi kết thúc (VD: "Từ đồ bỏ đi cũng viết nên truyện hay. Cùng Góc nhỏ cổ tích tái chế nhé, hôm nay bạn sẽ làm món gì?").
  ...
  "script": [
    {
      ...
      "voice_profile": {
        ...
        "age": "Độ tuổi cụ thể (VD: 18 tuổi, 50 tuổi, 70 tuổi...)",
        "accent": "Giọng vùng miền chuẩn (VD: Giọng Bắc chuẩn, Giọng Nam bộ...)",
        "timbre": "Chất giọng",
        "tone": "Giọng điệu",
        "pacing": "Nhịp",
...
REQUIRED JSON OUTPUT:
{
  ...
  "video_description": {
    ...
    "full_description": "Complete description (300-500 words) emphasizing eco-art journey. MUST INCLUDE COPPA DISCLAIMER: 'Video này hướng dẫn nghệ thuật thủ công phức tạp, dành cho khán giả trên 13 tuổi đam mê sáng tạo và bảo vệ môi trường.'",
    "timestamps": [
  ...
  "thumbnail_suggestions": [
    {
      "concept_name": "Tên concept (VD: Biến Hình Shock, Bật Mí Bí Mật...)",
      "visual_concept": "Mô tả hình ảnh: Before/After, góc chụp cận cảnh...",
      "text_on_image": "TEXT TRÊN ẢNH (ngắn gọn 3-5 từ, in hoa, giật tít)",
      "color_psychology": "Tông màu chủ đạo (VD: Tương phản mạnh, Vàng Gold sang trọng...)",
      "ai_image_prompt": "Prompt tiếng Anh chi tiết để tạo ảnh bằng Midjourney/DALL-E"
    }
  ],
  "engagement_comments": {
...
- Vị trí (State): Xác định rõ ON-SCREEN hay OFF-SCREEN.
