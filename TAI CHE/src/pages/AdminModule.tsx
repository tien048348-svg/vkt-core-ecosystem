            ...
            <div className="bg-[#0a0e14]/80 border border-teal-900/50 p-4 rounded-lg flex items-center justify-between">
              <div>
                <div className="font-black text-teal-400 text-sm flex items-center gap-2">
                  V20.0 (Global Sync & Smart Chunking) <span className="px-1.5 py-0.5 rounded bg-teal-900 text-[9px] text-white">HIỆN TẠI</span>
                </div>
                <div className="text-xs text-slate-500 mt-1">Tích hợp thanh Omni-Progress Bar đồng bộ 100% hệ thống và Firestore Cloud.</div>
              </div>
