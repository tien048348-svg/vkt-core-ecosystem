...
const TABS: { id: TabId; icon: string; title: string; subtitle: string }[] = [
  { id: 'spy', icon: 'fa-solid fa-magnifying-glass-chart', title: '1. TREND SCOUT', subtitle: 'Phân Tích Kênh Nhạc Thiền' },
  { id: 'script', icon: 'fa-solid fa-scroll', title: '2. SOUND DESIGNER', subtitle: 'Thiết Kế Nhạc Nền Thiền' },
  { id: 'studio', icon: 'fa-solid fa-palette', title: '3. SUNO MASTER', subtitle: 'Xưởng Viết Prompt Suno' },
  { id: 'seo', icon: 'fa-solid fa-seedling', title: '4. ZEN SEO', subtitle: 'Tối Ưu Viral Nhạc' },
];
          ...
          <button
            ...
            className={`p-4 rounded-xl text-left border transition-all shrink-0 min-w-[200px] md:min-w-0 ${
              isActive
                ...
                : `bg-transparent border-transparent text-slate-500 hover:bg-emerald-950/20 hover:border-emerald-950/40 hover:text-slate-300 ${isStudioDisabled ? 'opacity-30 cursor-not-allowed' : ''}`
            }`}
          >
