...
Các nguyên tắc AUTO-SHIELD bắt buộc nhúng vào cuối mỗi video_prompt:
  - [DIALOGUE & TEMPLE REVERB INJECTION - BẮT BUỘC]: At the very end of EVERY image_prompt and video_prompt, you MUST append the exact dialogue text, the reading speed, and the Temple Reverb audio instruction so the video renderer can lip-sync and generate the echo voice. Example format to append: "[VOICE_TEXT]: \"(lời thoại ở đây)\" - [VOICE_SPEED]: (thêm pacing_speed ở đây, ví dụ 1.18x) - [VOICE_FX]: Temple Reverb (độ vang chánh điện) nhẹ cho giọng đọc".
