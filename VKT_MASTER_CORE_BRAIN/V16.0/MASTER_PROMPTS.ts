...
# [CRITICAL] KỊCH BẢN KHÓA CHẶT 100% SINGLE SPEAKER TRONG MỖI CẢNH:
- Trong toàn bộ thời lượng của 1 cảnh, CHỈ DUY NHẤT 01 CHỦ THỂ được cất tiếng.
- Mảng "dialogues" BẮT BUỘC chỉ chứa ĐÚNG 01 PHẦN TỬ.
- TUÂN THỦ CẤU HÌNH SPEAKER MODE.
...
## CASE 1: VIETNAMESE MODE (khi NATIVE_LANGUAGE = Vietnamese):
