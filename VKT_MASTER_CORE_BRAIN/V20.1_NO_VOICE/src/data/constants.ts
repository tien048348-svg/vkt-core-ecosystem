...
export const VISUAL_STYLES: VisualStyle[] = [
  ...
  { id: 'zen_monastic_realism', name: '🙏 Thiền Môn Thường Nhật (Storytelling)', desc: 'Phong cách tả thực, mộc mạc. Ánh sáng tự nhiên (Natural Light), phù hợp kể chuyện đời thường.', prompt_enforce: ', [HYBRID CORE]: 8K Resolution, Cinematic Realism + Natural Light. Visual Style: Authentic, grounded, and hyper-realistic depiction of a serene ancient temple environment. [PHYSICAL ANCHOR LOCK]: Characters wearing traditional humble robes (if any). [SCENE DYNAMICS LOCK]: Soft diffused morning light, subtle mist, highly detailed natural textures of wood, stone, and leaves. [AUDIO LOCK]: Authentic ambient sounds, sweeping leaves, distant natural wind, no exaggerated sci-fi effects.' },
  { id: 'soft_watercolor_fable', name: '🎨 Cổ Tích Thủy Mặc (Storytelling)', desc: 'Phong cách vẽ màu nước dịu nhẹ, hoài cổ. Phù hợp các câu chuyện tình mẫu tử, Đạo Hiếu.', prompt_enforce: ', [HYBRID CORE]: 8K Resolution, Studio Ghibli style meets Traditional Watercolor Art. Visual Style: Gentle, nostalgic, and emotionally resonant watercolor painting with soft pastel colors and flowing brushstrokes. [PHYSICAL ANCHOR LOCK]: A warm, inviting atmosphere with gentle rounded shapes. [SCENE DYNAMICS LOCK]: Dreamy, soft-focus background, evoking a sense of childhood memory and tender warmth. [AUDIO LOCK]: Soft acoustic string instruments, gentle emotional piano, comforting and soothing breeze.' },
  { id: 'ancient_vedic_epic', name: '🏛️ Sử Thi Cổ Đại (Storytelling)', desc: 'Góc máy rộng (Wide angle), bối cảnh sa mạc/hoàng cung hoành tráng thời Đức Phật.', prompt_enforce: ', [HYBRID CORE]: 8K Resolution, Epic Historical Cinematography + Wide Establishing Shots. Visual Style: Grand, majestic, and sweeping landscapes of ancient India/Vedic civilization. [PHYSICAL ANCHOR LOCK]: Massive ancient architecture, palaces, or vast deserts. [SCENE DYNAMICS LOCK]: Golden hour harsh sunlight casting long dramatic shadows, epic scale showing tiny characters against vast backgrounds. [AUDIO LOCK]: Majestic orchestral drums, epic chanting, vast desert wind.' },
  { id: 'minimalist_emptiness', name: '⚪ Khoảng Không Tối Giản (Storytelling)', desc: 'Chỉ có đen trắng và ánh sáng, nhấn mạnh Tánh Không (Emptiness).', prompt_enforce: ', [HYBRID CORE]: 8K Resolution, Extreme Minimalism + Chiaroscuro Lighting. Visual Style: Strikingly simple, high-contrast black and white (or monochromatic) composition focusing entirely on negative space (Ma) and profound stillness. [PHYSICAL ANCHOR LOCK]: A single, powerful symbolic subject (e.g., a monk silhouette, a lone tree). [SCENE DYNAMICS LOCK]: Complete stillness, perfect geometric balance, intense play of light and deep shadows. [AUDIO LOCK]: Absolute silence broken only by a single resonating meditation bowl strike every 10 seconds.' }
];
