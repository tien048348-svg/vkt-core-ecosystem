...
export interface GlobalSettings {
  ...
  enableAdminSpeedOverride?: boolean;
  speedOverrides?: {
    tier1: SpeedTier;
    tier2: SpeedTier;
    tier3: SpeedTier;
...
const DEFAULT_SETTINGS: GlobalSettings = {
  ...
  enableAdminSpeedOverride: false,
  speedOverrides: {
...
const App: React.FC = () => {
  ...
  const handleUseStrategy = useCallback((title: string, link?: string) => {
    setStrategyTopic(title);
    if (link) setReferenceLink(link);
