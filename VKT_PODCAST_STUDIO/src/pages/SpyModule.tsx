...
const SpyModule: React.FC<SpyModuleProps> = ({ onUseStrategy }) => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      prompt += `\nANALYZE [TEN_NGACH_EN] CONTENT. RESPOND ALL TEXT FIELDS IN VIETNAMESE.`;
    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-[slideIn_0.4s_ease-out]">
      ...
      <div className="bg-[#12161e] border border-slate-700/30 p-6 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]">
        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
          <i className="fa-brands fa-youtube text-red-500" /> Phân Tích Kênh [TEN_NGACH_VI]
        </h2>
        <div className="flex gap-2 mb-4">
          <input 
            ...
            placeholder="Dán link Video/Kênh [TEN_NGACH_VI]..."
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              ...
              <span className="text-slate-300">
                Bạn có thể dán <strong>BẤT KỲ link YouTube nào</strong>! Hệ thống AI V16.0 sẽ tự động "bẻ lái" và chuyển thể 100% sang nội dung phù hợp ngách <strong>[TEN_NGACH_VI]</strong> triệu view.
              </span>
            </div>
          </div>
        </div>
