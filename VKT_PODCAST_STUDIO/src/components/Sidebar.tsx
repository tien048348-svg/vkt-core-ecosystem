...
const TABS: { id: TabId; icon: string; title: string; subtitle: string }[] = [
  { id: 'spy', icon: 'fa-solid fa-magnifying-glass-chart', title: '1. PODCAST SCOUT', subtitle: 'Phân Tích Kênh Podcast' },
  { id: 'script', icon: 'fa-solid fa-microphone-lines', title: '2. SCRIPT WRITER', subtitle: 'Viết Kịch Bản Deep Talk' },
  { id: 'studio', icon: 'fa-solid fa-headphones', title: '3. AUDIO STUDIO', subtitle: 'Xưởng Sản Xuất' },
  { id: 'seo', icon: 'fa-solid fa-rocket', title: '4. VIRAL SEO', subtitle: 'Tối Ưu Phát Hành' },
];
