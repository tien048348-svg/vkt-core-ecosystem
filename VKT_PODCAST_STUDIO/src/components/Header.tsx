        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg md:text-xl font-black tracking-tighter text-slate-100">
              VKT <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-300">PODCAST STUDIO</span>
            </h1>
            <p className="text-[9px] text-amber-600/80 tracking-widest font-mono font-bold">DEEP TALK & INTERVIEW STUDIO</p>
          </div>
        </div>
